...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    original_name = media.file_name if hasattr(media, "file_name") else f"file_{uuid.uuid4()}.mp4"
...
bot_app.add_handler(MessageHandler(filters.Document.ALL | filters.Video.ALL | filters.PHOTO | filters.Audio.ALL, handle_file))
